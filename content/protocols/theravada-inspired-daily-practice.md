---
id: theravada-inspired-daily-practice
title: 上座部仏教系瞑想を日常で参照する
type: protocol
status: draft
summary: 上座部仏教系の瞑想概念を、宗教実践や臨床介入の代替にせず、日常の短い気づきとして参照するための慎重なガイド。
tags:
  - theravada
  - daily-practice
  - mindfulness
...
このページは、上座部仏教系の瞑想概念を日常で短く参照するための慎重なガイドです。

宗教実践、正式な修行体系、臨床介入、医療・心理療法の代替ではありません。
...
2. 自然な呼吸を数回感じる。
3. 今日の心の状態を一語で見る。
4. 無理なくできる小さい善い行動を一つ選ぶ。

呼吸が苦しい場合は、足裏、手の接触、外の音へ移ります。

## 日中の1分

忙しい時は、身体、感受、心の順で短く見ます。
...
相手に反応する前に、短いmettāの句を使えます。

例: 「自分と相手が安全でありますように」。ただし、これは許すこと、和解すること、境界線を外すことではありません。

## 寝る前の1分

長い内観ではなく、終えるための確認にします。

- 今日の身体の疲れを一つ見る。
- 不快な感受があれば「不快」とだけ名づける。
- 眠れなくなるなら中止し、明かり、音、寝具など外側の調整へ戻る。
...
[[mindfulness-practice-log]]には、短く次を残します。
...
強い不安、トラウマ反応、解離、躁的高揚、精神病症状、自傷・他害リスク、睡眠悪化がある場合は、自己流で深めません。

[[mindfulness-safety]]を読み、必要なら専門的支援や安全確保を優先します。
