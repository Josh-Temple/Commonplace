...
type: concept
status: draft
summary: 思考や感情を心に現れた出来事として見る脱中心化を整理するページ。
tags:
  - mindfulness
  - metacognition
  - emotion-regulation
...
この考え方は、MBCT、ACTの脱フュージョン、[[self-distancing]]、[[open-monitoring-meditation]]と重なります。
...
[[open-monitoring-meditation]]では、感覚、思考、感情を広く観察します。その中で、思考が現れ、変化し、消えることを経験的に見ます。
...
感情が強い時に使う短い手順は[[emotion-regulation-mindfulness-protocol]]へ進みます。
