# Nominal rates, real rates, and inflation expectations — research note

## Purpose

Support nominal/real decomposition, TIPS, breakeven limitations, and official inflation definitions.

## Evidence record

- **TIPS in Depth** — U.S. Treasury, TreasuryDirect. https://www.treasurydirect.gov/marketable-securities/tips/tips-in-depth/ — Supports CPI indexation, principal adjustment, coupon, and maturity mechanics. Limitation: does not make breakeven a pure forecast.
- **The TIPS Yield Curve and Inflation Compensation** — Federal Reserve Board, FEDS data. https://www.federalreserve.gov/data/tips-yield-curve-and-inflation-compensation.htm — Supports model-based real yields and inflation compensation. Limitation: estimates are model-dependent.
